        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-1.5 sm:px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="flex items-center gap-1.5 font-mono-id text-xs uppercase tracking-widest">
              <span className="h-2 w-2 rounded-full bg-secondary shadow-[0_0_8px_hsl(72_76%_50%)]" />ACTIVE
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
          <div className="flex items-center justify-between gap-4">
            ...
            <nav className="hidden items-center gap-1 lg:flex" aria-label="Primary">
              <a href="#categories" className="px-3 py-2 text-sm font-medium uppercase tracking-wide text-foreground transition-colors hover:bg-secondary hover:text-primary">Categories</a>
              <a href="#guides" className="px-3 py-2 text-sm font-medium uppercase tracking-wide text-foreground transition-colors hover:bg-secondary hover:text-primary">Guides</a>
              <a href="#suppliers" className="px-3 py-2 text-sm font-medium uppercase tracking-wide text-foreground transition-colors hover:bg-secondary hover:text-primary">Suppliers</a>
              <a href="#sources" className="px-3 py-2 text-sm font-medium uppercase tracking-wide text-foreground transition-colors hover:bg-secondary hover:text-primary">Sources</a>
            </nav>
          </div>
        </div>
      </header>
              ...
              <div className="flex items-start gap-4 bg-card p-6 shadow-paper animate-fade-up">
                ...
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-3">
                    ...
                    <span className="flex items-center gap-1 font-mono-id text-xs text-secondary"><span className="h-1.5 w-1.5 rounded-full bg-secondary shadow-[0_0_4px_hsl(72_76%_50%)]" />SHA-256 verified</span>
                  </div>
                </div>
              </div>
              <div className="flex items-start gap-4 bg-card p-6 shadow-paper animate-fade-up" style={{ animationDelay: '0.1s' }}>
                ...
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-3">
                    ...
                    <span className="flex items-center gap-1 font-mono-id text-xs text-secondary"><span className="h-1.5 w-1.5 rounded-full bg-secondary shadow-[0_0_4px_hsl(72_76%_50%)]" />Integrity clean</span>
                  </div>
                </div>
              </div>
            </div>
