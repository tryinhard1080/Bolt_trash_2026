...
import {
  ...
  Hash, Route, Crosshair, Navigation, Fingerprint, Layers,
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-6xl px-6 py-8 sm:px-8 sm:py-10">
          <div className="flex items-end justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-serif-display text-3xl font-bold leading-none text-primary sm:text-4xl" style={{ textWrap: 'balance' }}>
                  The Trash Hub
                </h1>
            ...
            <nav className="hidden md:flex md:items-center md:gap-1" aria-label="Primary">
              <a href="#guides" className="rounded-sm px-3 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Guides</a>
              <a href="#suppliers" className="rounded-sm px-3 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Suppliers</a>
              <a href="#sources" className="rounded-sm px-3 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Sources</a>
            </nav>
          </div>
        </div>
      </header>
      ...
      <main id="main">
            ...
            <div className="grid gap-10 md:grid-cols-12 md:items-center">
              <div className="md:col-span-5 animate-fade-up">
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  <a href="#guides" className="inline-flex min-h-[44px] items-center gap-2 rounded-sm bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
                    Open the atlas <ArrowRight className="h-4 w-4" aria-hidden="true" />
                  </a>
                  <a href="#suppliers" className="inline-flex min-h-[44px] items-center gap-2 rounded-sm border border-primary px-5 py-2.5 text-sm font-medium text-primary transition-colors hover:bg-primary hover:text-primary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
                    Supplier directory
                  </a>
                </div>
              </div>
              <div className="md:col-span-7 animate-fade-in">
                <div className="relative overflow-hidden rounded-sm border-2 border-primary shadow-md">
                  <img src="/atlas-cartographic.webp" alt="Cartographic survey map of waste collection routes with dashed wayfinding lines and transfer station markers" className="w-full object-cover" width={700} height={450} />
                  <div className="absolute left-3 top-3 rounded-sm border border-accent bg-card px-2.5 py-1">
                    <p className="font-mono-id text-xs text-accent">SURVEY MAP / 01</p>
                  </div>
                  <div className="absolute bottom-3 right-3 flex items-center gap-2 rounded-sm border border-primary bg-card px-2.5 py-1">
        ...
        {/* Survey routes — varied layout, NOT identical cards */}
        <section className="border-b border-border bg-card" aria-labelledby="routes-heading">
          <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8 sm:py-16">
            <div className="flex items-end justify-between">
              <h2 id="routes-heading" className="font-serif-display text-2xl font-bold text-primary" style={{ textWrap: 'balance' }}>
                Survey routes
              </h2>
              <span className="font-mono-id text-xs text-muted-foreground">{ROUTES.length} routes logged</span>
            </div>

            {/* R-01 featured route — wide, with map line */}
            <div className="mt-8 grid gap-4 lg:grid-cols-12">
              <article className="group rounded-sm border border-dashed border-border bg-background p-6 transition-all hover:border-primary hover:border-solid hover:shadow-sm lg:col-span-7 animate-fade-up">
              ...
              {/* R-02 stacked compact */}
              <article className="group rounded-sm border border-dashed border-border bg-background p-6 transition-all hover:border-primary hover:border-solid hover:shadow-sm lg:col-span-5 animate-fade-up">
                <div className="flex items-center justify-between">
              ...
              {/* R-03 — inline row, different proportion */}
              <article className="group flex items-center gap-4 rounded-sm border border-dashed border-border bg-background p-5 transition-all hover:border-primary hover:border-solid hover:shadow-sm lg:col-span-5 animate-fade-up">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-2 border-primary">
                ...
                <div className="flex-1">
                  ...
                  <p className="font-mono-id text-xs text-muted-foreground">{ROUTES[2].start} → {ROUTES[2].end} · {ROUTES[2].distance}</p>
                </div>
              </article>

              {/* R-04 — wider inline */}
              <article className="group flex items-center gap-4 rounded-sm border border-dashed border-border bg-background p-5 transition-all hover:border-primary hover:border-solid hover:shadow-sm lg:col-span-7 animate-fade-up">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-2 border-primary">
                ...
                <div className="flex-1">
                  ...
                  <p className="font-mono-id text-xs text-muted-foreground">{ROUTES[3].start} → {ROUTES[3].end} · {ROUTES[3].distance}</p>
                </div>
        ...
        <section id="guides" className="border-b border-border" aria-labelledby="guides-heading">
          <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8 sm:py-16">
            ...
            <p className="mt-2 max-w-[65ch] text-sm text-muted-foreground">
              Four field guides organized by lifecycle stage. Each carries a coordinate reference for cross-reading with the atlas plates.
            </p>
            ...
            <div className="mt-8 grid gap-px bg-border sm:grid-cols-2 lg:grid-cols-4">
              {GUIDES.map((guide, i) => (
                <article
                  key={guide.id}
                  className={`group bg-card p-6 transition-colors hover:bg-background animate-fade-up ${i === 0 || i === 3 ? 'sm:col-span-2 lg:col-span-2' : ''}`}
                >
                  <div className="flex items-center gap-2">
                  ...
                  <h3 className="mt-3 font-serif-display text-lg font-semibold text-foreground group-hover:text-primary" style={{ textWrap: 'balance' }}>
                    {guide.title}
                  </h3>
                  ...
                  {i === 0 && (
                    <p className="mt-4 max-w-[55ch] text-sm leading-relaxed text-muted-foreground">
                      The entry point for every other guide. Start here to map property access before tracing materials downstream.
                    </p>
                  )}
        ...
        <section className="border-b border-border bg-card" aria-labelledby="atlas-heading">
          <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8 sm:py-16">
            ...
            <div className="mt-6 overflow-hidden rounded-sm border-2 border-primary shadow-sm animate-scale-in">
              <img src="/guide-atlas.webp" alt="Three-panel visual guide atlas for waste systems showing access, materials, and site walks" className="w-full object-cover" width={1000} height={450} />
            </div>
            <div className="mt-6 grid gap-6 sm:grid-cols-3">
              {[
                ...
                <div key={panel.ref} className="rounded-sm bg-background p-4">
                  <div className="flex items-center gap-2">
        ...
        <section id="suppliers" className="border-b border-border" aria-labelledby="suppliers-heading">
          <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8 sm:py-16">
            ...
            <div className="mt-8 overflow-x-auto rounded-sm border border-dashed border-border">
        ...
        <section id="sources" className="border-b border-border bg-card" aria-labelledby="sources-heading">
          <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8 sm:py-16">
            ...
            <p className="mt-2 max-w-[65ch] text-sm leading-relaxed text-muted-foreground">
              Every claim and supplier entry traces back to an approved public-source snapshot. Source IDs are listed for inspection, not as endorsements.
            </p>
            <div className="mt-8 flex items-start gap-4 rounded-sm border border-dashed border-border bg-background p-5 animate-fade-up">
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-1.5">
                  ...
                  <span className="flex items-center gap-1 font-mono-id text-xs text-secondary">
                    <span className="h-1.5 w-1.5 rounded-full bg-secondary" aria-hidden="true" /> SHA-256 verified
                  </span>
          ...
          <div className="mx-auto max-w-6xl px-6 py-6 sm:px-8">
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
              ...
              <span id="ww-heading">
                ...
                <a href="#" className="font-medium text-accent underline underline-offset-2 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
        ...
        <div className="mx-auto max-w-6xl px-6 py-10 sm:px-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-[50ch] text-xs text-primary-foreground/70">
            ...
            <nav className="flex flex-wrap gap-x-6 gap-y-2 text-xs text-primary-foreground/80" aria-label="Footer">
              <a href="#guides" className="min-h-[44px] flex items-center hover:text-primary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground/40">Guides</a>
              <a href="#suppliers" className="min-h-[44px] flex items-center hover:text-primary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground/40">Suppliers</a>
              <a href="#sources" className="min-h-[44px] flex items-center hover:text-primary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground/40">Sources</a>
              <a href="#" className="min-h-[44px] flex items-center hover:text-primary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground/40">WasteWise</a>
            </nav>
          </div>
